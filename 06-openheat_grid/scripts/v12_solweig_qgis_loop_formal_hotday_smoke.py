"""
v12 SOLWEIG manifest-driven QGIS Python Console loop 鈥?path-safe fixed version.
...
MANIFEST = PROJECT_ROOT / "configs/v12/v12_solweig_formal_hotday_smoke_manifest.csv"
LOG_FILE = PROJECT_ROOT / "outputs/v12_solweig_typology_pilot/v12_solweig_qgis_loop_formal_hotday_smoke_log.txt"
...
def main() -> None:
    ...
    print("=" * 70)
    print("v12 SOLWEIG QGIS loop 鈥?path-safe version")
