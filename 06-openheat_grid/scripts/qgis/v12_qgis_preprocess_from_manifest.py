...
What this does:
  ...
  3. Writes a CSV + text log under outputs/v12_solweig_typology_pilot/qgis_preprocess/.
...
MANIFEST = f"{PROJECT_ROOT}/configs/v12/v12_solweig_preprocess_core8_overhead_manifest.csv"
OUT_DIR = Path(PROJECT_ROOT) / "outputs/v12_solweig_typology_pilot/qgis_preprocess"
LOG_TXT = OUT_DIR / "v12_qgis_preprocess_log.txt"
LOG_CSV = OUT_DIR / "v12_qgis_preprocess_log.csv"
